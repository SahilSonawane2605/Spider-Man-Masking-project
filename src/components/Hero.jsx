      ...
      >
        ...
        <motion.div className="left" variants={item}>
          ...
          <h1
           className="st-title"
           style={{
                    fontFamily: "'Bebas Neue', 'Cinzel Decorative', cursive",
        ...
        <span style={{ color: 'white' }}>MAN</span>
         <br />
          ...
          <motion.p className="st-desc" variants={item}
           ...
           A hero by choice, not by destiny. Every swing a leap of faith. Every mask a sacrifice. 
           Beneath the suit is just a kid trying to do the right thing in a world that rarely makes it easy.
        ...
        <motion.div className="right" variants={item}>
          ...
          <h1 className="st-title"
            ...
            The Man<br />Behind the Webs
          </h1>
          <motion.p className="st-text" variants={item}
            style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic' }}>
            Every bruise a lesson. Every loss a reminder. He saves a city that may never know his name, carrying the weight of responsibility on shoulders never meant to bear it alone.

            No throne.
            No army.
            No super-soldier serum.

            Just courage, heart, and a promise to never stop showing up when people need him most.

            Can one hero protect a city that never stops falling?</motion.p> 
        </motion.div>
      </motion.div>
